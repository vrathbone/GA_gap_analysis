...
GA_area_polygon <- rasterToPolygons(GA_area, fun=function(x){x==0.5})

plot(GA_area_polygon)

writeOGR(GA_area_polygon, dsn = here('C:/Users/vanessa_rathbone/Dropbox/Greater_Antilles/VR files/VR Files/outputs/GA_area_polygon.shp'), layer = 'poly', driver = "ESRI Shapefile")
...
geomorph_stack <- stack(abyssal_rast, insular_upper_rast, isobata_rast, geomorph_rast, plateaus_rast, ridges_rast, spreading_ridges_rast)
