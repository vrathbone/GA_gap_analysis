...
GA_rast <- raster(here("C:/Users/vanessa_rathbone/Dropbox/Greater_Antilles/2_Grid/grid_rast_84"))
...
GA_sf <- sf::read_sf(here("C:/Users/vanessa_rathbone/Dropbox/Greater_Antilles/2_Grid/Grid_2.shp"))
...
Read in the conservation features, habitat and species
```{r}
...
writeRaster(pa, here('C:/Users/vanessa_rathbone/Dropbox/Greater_Antilles/1_sources/Rey/WDPA_WDOECM_SA_Polyg_ALL_GAE/GA_pa.tif'), overwrite = TRUE)
